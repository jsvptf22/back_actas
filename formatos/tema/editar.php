...
$FtTema = FtTema::findByDocumentId($_REQUEST["iddoc"]);
        ...
        <div class='card card-default'>
            <div class='card-body'>
                ...
                <form 
                    ...
                    autocomplete='off' 
                    >
                    <input type='hidden' name='idft_tema' value='<?= ComponentFormGeneratorController::callShowValue(
                'idft_tema',
                $FtTema,
                460,
            ) ?>'>
...
<input type='hidden' name='ft_acta' value='<?= $FtTema->ft_acta ?>'>
        <?php
...
<div class='form-group px-0 pt-3' id='form_buttons'><button class='btn btn-complete mr-2' id='save_item' type='button'>Guardar</button></div>
                </form>
            </div>
        </div>
    </div>
