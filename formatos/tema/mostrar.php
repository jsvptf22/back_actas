...
try {
    ...
    $FtTema = FtTema::findByDocumentId($documentId);
                        ...
                        <div id="pag-0" class="col-12 page_border bg-white">
                            ...
                            <div id="pag_content-0" class="page_content">
                                <div id="page_overflow">
                                    <p><?= ComponentFormGeneratorController::callShowValue('nombre',$FtTema,460) ?></p>

<p><?= ComponentFormGeneratorController::callShowValue('desarrollo',$FtTema,460) ?></p>
